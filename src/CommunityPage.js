...
/**
 * The `CommunityPage` component serves as a container for rendering a specific chat room
 * within the Chat Engine. It wraps the chat functionality using the `ChatEngineWrapper`,
 * establishes a connection to a chat room using the `ChatSocket`, and displays the chat's
